...
public class OthersFoodActivity extends AppCompatActivity {
    ...
    private RecyclerView others_food_recycler_view;
    private StaggeredGridLayoutManager mLayoutManager;
    private ProductsAdapter productsAdapter;
    private DatabaseReference othersFoodReference;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (others_food_recycler_view != null) {
            ...
            others_food_recycler_view.setHasFixedSize(true);
        }
        ...
        others_food_recycler_view.setLayoutManager(mLayoutManager);
        others_food_recycler_view.setHasFixedSize(true);
        fetch();
    ...
    private void fetch(){
        ...
        othersFoodReference = FirebaseDatabase.getInstance().getReference().child("others").child("others food");

        othersFoodReference.addChildEventListener(new ChildEventListener() {
            @Override
...
//                for (DataSnapshot dataSnapshot1: dataSnapshot.getChildren()){
                ...
                productsAdapter = new ProductsAdapter(OthersFoodActivity.this, list);
                others_food_recycler_view.setAdapter(productsAdapter);
            }
